...
import { Play, Pause, Maximize, Loader2, ListMusic, AudioWaveform, Activity } from 'lucide-react';
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Button
              variant="ghost"
              size="icon"
              className={cn(activeDrawer === 'dashboard' && "bg-accent text-accent-foreground")}
              onClick={() => setActiveDrawer(activeDrawer === 'dashboard' ? 'none' : 'dashboard')}
              title="Pipeline Dashboard (D)"
            >
